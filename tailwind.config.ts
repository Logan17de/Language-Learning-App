  ...
  theme: {
    extend: {
      colors: {
        ...
        positive: "rgb(var(--aiko-positive) / <alpha-value>)",
        "positive-surface": "rgb(var(--aiko-positive-surface) / <alpha-value>)",
        "positive-border": "rgb(var(--aiko-positive-border) / <alpha-value>)",
        warning: "rgb(var(--aiko-warning) / <alpha-value>)",
        "warning-surface": "rgb(var(--aiko-warning-surface) / <alpha-value>)",
        "warning-border": "rgb(var(--aiko-warning-border) / <alpha-value>)",
        danger: "rgb(var(--aiko-danger) / <alpha-value>)",
        "danger-surface": "rgb(var(--aiko-danger-surface) / <alpha-value>)",
        "danger-border": "rgb(var(--aiko-danger-border) / <alpha-value>)",
        moss: {
          50: "#f2f7f4",
          100: "#e2eee7",
          200: "#c5ddcf",
