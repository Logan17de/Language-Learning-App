...
export async function GET() {
  ...
  const [profile, preferences, settings, subscriptions, sessions, completions, mastery, queue, reviews, reports, tickets] = await Promise.all([
  ...
  const firstError = [profile, preferences, settings, subscriptions, sessions, completions, mastery, queue, reviews, reports, tickets].find((result) => result.error)?.error;
