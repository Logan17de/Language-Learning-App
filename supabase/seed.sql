...
values
  ('10000000-0000-4000-8000-000000000101', '16000000-0000-4000-8000-000000000001', 1, '朝', 'あさ', 'morning', 'kanji'),
  ('10000000-0000-4000-8000-000000000101', '16000000-0000-4000-8000-000000000001', 2, 'ゆきさん', 'ゆきさん', 'Yuki', 'hiragana'),
  ('10000000-0000-4000-8000-000000000101', '16000000-0000-4000-8000-000000000001', 3, 'は', 'は', 'topic marker', 'hiragana'),
  ('10000000-0000-4000-8000-000000000101', '16000000-0000-4000-8000-000000000001', 4, '六時半', 'ろくじはん', '6:30', 'kanji'),
  ('10000000-0000-4000-8000-000000000101', '16000000-0000-4000-8000-000000000001', 5, 'に', 'に', 'at / to', 'hiragana'),
  ('10000000-0000-4000-8000-000000000101', '16000000-0000-4000-8000-000000000001', 6, '起きます', 'おきます', 'wake up', 'kanji'),
  ('10000000-0000-4000-8000-000000000101', '16000000-0000-4000-8000-000000000002', 1, 'コーヒー', 'コーヒー', 'coffee', 'katakana'),
  ('10000000-0000-4000-8000-000000000101', '16000000-0000-4000-8000-000000000002', 2, 'を', 'を', 'object marker', 'hiragana'),
  ('10000000-0000-4000-8000-000000000101', '16000000-0000-4000-8000-000000000002', 3, '飲み', 'のみ', 'drink', 'kanji'),
  ('10000000-0000-4000-8000-000000000101', '16000000-0000-4000-8000-000000000002', 4, 'ながら', 'ながら', 'while doing', 'hiragana'),
  ('10000000-0000-4000-8000-000000000101', '16000000-0000-4000-8000-000000000002', 5, 'ニュース', 'ニュース', 'news', 'katakana'),
  ('10000000-0000-4000-8000-000000000101', '16000000-0000-4000-8000-000000000002', 6, 'を', 'を', 'object marker', 'hiragana'),
  ('10000000-0000-4000-8000-000000000101', '16000000-0000-4000-8000-000000000002', 7, '読みます', 'よみます', 'read', 'kanji'),
  ('10000000-0000-4000-8000-000000000101', '16000000-0000-4000-8000-000000000003', 1, '音楽', 'おんがく', 'music', 'kanji'),
  ('10000000-0000-4000-8000-000000000101', '16000000-0000-4000-8000-000000000003', 2, 'を', 'を', 'object marker', 'hiragana'),
  ('10000000-0000-4000-8000-000000000101', '16000000-0000-4000-8000-000000000003', 3, '聞き', 'きき', 'listen', 'kanji'),
  ('10000000-0000-4000-8000-000000000101', '16000000-0000-4000-8000-000000000003', 4, 'ながら', 'ながら', 'while doing', 'hiragana'),
  ('10000000-0000-4000-8000-000000000101', '16000000-0000-4000-8000-000000000003', 5, '駅', 'えき', 'station', 'kanji'),
  ('10000000-0000-4000-8000-000000000101', '16000000-0000-4000-8000-000000000003', 6, 'まで', 'まで', 'as far as', 'hiragana'),
  ('10000000-0000-4000-8000-000000000101', '16000000-0000-4000-8000-000000000003', 7, '歩きます', 'あるきます', 'walk', 'kanji'),
  ('10000000-0000-4000-8000-000000000101', '16000000-0000-4000-8000-000000000004', 1, '改札', 'かいさつ', 'ticket gate', 'kanji'),
  ('10000000-0000-4000-8000-000000000101', '16000000-0000-4000-8000-000000000004', 2, 'で', 'で', 'at / by means of', 'hiragana'),
  ('10000000-0000-4000-8000-000000000101', '16000000-0000-4000-8000-000000000004', 3, '同僚', 'どうりょう', 'colleague', 'kanji'),
  ('10000000-0000-4000-8000-000000000101', '16000000-0000-4000-8000-000000000004', 4, 'の', 'の', 'possessive marker', 'hiragana'),
  ('10000000-0000-4000-8000-000000000101', '16000000-0000-4000-8000-000000000004', 5, '田中さん', 'たなかさん', 'Mr. Tanaka', 'kanji'),
  ('10000000-0000-4000-8000-000000000101', '16000000-0000-4000-8000-000000000004', 6, 'に', 'に', 'to', 'hiragana'),
  ('10000000-0000-4000-8000-000000000101', '16000000-0000-4000-8000-000000000004', 7, '会います', 'あいます', 'meet', 'kanji')
