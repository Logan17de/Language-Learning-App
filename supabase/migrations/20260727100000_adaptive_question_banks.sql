-- Allow a larger adaptive candidate bank while preserving compatibility with
-- existing ten-question lesson packages. The player still serves exactly ten.
...
begin
  ...
  if jsonb_typeof(p_package) <> 'object'
     ...
     or jsonb_array_length(p_package->'vocabularyQuestions') not between 10 and 13
     or jsonb_typeof(p_package->'grammarQuestions') <> 'array'
     or jsonb_array_length(p_package->'grammarQuestions') not between 10 and 13
