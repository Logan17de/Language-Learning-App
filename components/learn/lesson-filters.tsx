  ...
  return (
    <div className="rounded-3xl border border-border bg-surface p-4 shadow-card">
      ...
      <div className="mt-3 flex flex-wrap items-center gap-2">
        <SlidersHorizontal className="mx-2 size-4 text-muted" aria-hidden="true" />
...
function FilterSelect({
  ...
  return (
    <label>
      ...
      <select value={value} onChange={(event) => onChange(event.target.value)} className="min-h-11 rounded-full border border-border bg-surface px-4 text-xs font-semibold capitalize text-muted outline-none hover:border-moss-200 focus:border-moss-500 focus:ring-4 focus:ring-moss-100">
