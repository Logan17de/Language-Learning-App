    ...
    <header className="sticky top-0 z-30 border-b border-slate-200 bg-white/95 backdrop-blur">
      <div className="flex h-16 items-center gap-3 px-4 sm:px-6">
        ...
        >
          <label className="relative block">
            ...
            <input
              ...
              className="min-h-10 w-full rounded-xl border border-slate-200 bg-slate-50 pl-9 pr-3 text-sm outline-none focus:border-teal-500 focus:ring-4 focus:ring-teal-100"
        ...
        <Link
          ...
          aria-label="Open reports requiring attention"
          title="Reports"
        >
        ...
        <div className="relative">
          <button
            ...
            className="flex min-h-10 items-center gap-2 rounded-xl px-2 text-left hover:bg-slate-100"
          ...
          >
            ...
            <span className="hidden text-xs sm:block">
              <strong className="block text-slate-800">{session.displayName}</strong>
          ...
          {profileOpen && (
            <div className="absolute right-0 mt-2 w-56 rounded-xl border border-slate-200 bg-white p-2 shadow-xl">
              <p className="break-all px-3 py-2 text-xs text-slate-500">
                {session.email}
              </p>
              <button
                type="button"
