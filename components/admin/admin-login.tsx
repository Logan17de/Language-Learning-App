  ...
  return (
    <main className="grid min-h-screen bg-slate-950 px-5 py-12 text-white lg:grid-cols-2 lg:items-center lg:gap-12 lg:px-16">
      <section className="mx-auto max-w-xl">
        ...
        <p className="mt-6 max-w-lg leading-7 text-white/55">This frontend-only workspace uses deterministic mock data and local persistence. It is visually and operationally separated from the learner app.</p>
      </section>
      <section className="mx-auto mt-12 w-full max-w-md rounded-3xl bg-white p-7 text-slate-900 shadow-2xl lg:mt-0 sm:p-9">
        ...
        <p className="mt-2 text-sm text-slate-500">Use the documented local prototype credentials.</p>
        <form className="mt-7 space-y-5" onSubmit={submit}>
          ...
          <Button type="submit" className="w-full rounded-xl bg-slate-950 hover:bg-slate-800">Open admin workspace</Button>
        </form>
      </section>
    </main>
  );
